...
export const useFetchQestion = () => {
    ...
    useEffect(() => {
        ...
        (async() => {
            try {
                const [{questions, answers}] = await getServerData("http://mathped-be.vercel.app/questions", (data) => data)
...
export const useFetchQestionPretest = () => {
    ...
    useEffect(() => {
        ...
        (async() => {
            try {
                const [{questionsPretest, answersPretest}] = await getServerDataPretest("http://mathped-be.vercel.app/questionsPretest", (data) => data)
