            ...
            (async () => {
                try {
                    if (result !== 0 && username) {
                        await postServerData('http://mathped-be.vercel.app/result', resultData, (data) => data);
...
export const usePublishResultPretest = (resultData) => {
    ...
    (async () => {
        try {
            ...
            await postServerDataPretest('http://mathped-be.vercel.app/resultPretest', resultData, data => data)
        } catch (error) {
            console.log(error)
        }
    })();
...
export const PublishResultPosttest = async (resultData) => {
    const { result, username } = resultData;
    try {
        await postServerDataPretest('http://mathped-be.vercel.app/result', resultData, data => data)
        console.log('success')
    } catch (e){
        console.log(e)
    }
