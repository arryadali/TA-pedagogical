        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white ">
              <Link to={'/dashboard'}>
                <li className='block py-2 pl-3 pr-4 text-black rounded md:bg-transparent hover:text-[#1D809F] font-[Georgia]'>
                  Dashboard
                </li>
              </Link>

              <Link to={'/biodatasiswa'}>
                <li className='block py-2 pl-3 pr-4 rounded md:hover:bg-transparent text-black hover:text-[#1D809F] font-[Georgia]'>
                  Biodata Siswa
                </li>
              </Link>
