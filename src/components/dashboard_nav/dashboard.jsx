            ...
            <div className='flex justify-center items-center h-auto mt-10'>
              <div className='grid grid-cols-2 md:grid-cols-2 gap-8 w-[50%]'>
                <div className='flex flex-col items-center bg-[#1D809F] rounded-md '>
                  ...
                  <button className='text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 mt-3 font-[Georgia]'>
                    Lihat Profile
                  </button>
                </div>
